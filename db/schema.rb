...
ActiveRecord::Schema.define(version: 2021_10_21_085611) do
  ...
  create_table "user_offres", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "state"
    t.bigint "user_id"
    t.bigint "offre_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["offre_id"], name: "index_user_offres_on_offre_id"
    t.index ["user_id"], name: "index_user_offres_on_user_id"
  end
  ...
  add_foreign_key "user_offres", "offres"
  add_foreign_key "user_offres", "users"
end
